...
cat ../../charts/aggregion-cdp/values.yaml | yq -y '{
  ...
  backend: {
    ...
    configs: {
      ...
      serviceBcCheckerEnabled: .backend.configs.serviceBcCheckerEnabled,
      serviceBcSyncerEnabled: .backend.configs.serviceBcSyncerEnabled,
      serviceCrondEnabled: .backend.configs.serviceCrondEnabled,
