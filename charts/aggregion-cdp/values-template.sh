...
export DDM_MINIO_ACCESS_KEY=${DDM_MINIO_ACCESS_KEY:-CHANGEIT}
export DDM_MINIO_SECRET_KEY=${DDM_MINIO_SECRET_KEY:-CHANGEIT}
export DDM_MINIO_BUCKET=${DDM_MINIO_BUCKET:-CHANGEIT}
export MINIO_RELEASE_NAME=${MINIO_RELEASE_NAME:-minio-common}
export MINIO_NS=${MINIO_NS:-minio}
