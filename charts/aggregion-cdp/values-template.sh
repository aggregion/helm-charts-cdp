...
[[ $OLD_VALUES_AUTH_SERVICE_JWT_SECRET_KEY -eq 'null' ]] && OLD_VALUES_AUTH_SERVICE_JWT_SECRET_KEY=
...
[[ $OLD_VALUES_ACCOUNT_ID -eq 'null' ]] && OLD_VALUES_ACCOUNT_ID=
...
[[ $OLD_VALUES_BACKEND_CONFIGS_DMP_SECRET -eq 'null' ]] && OLD_VALUES_BACKEND_CONFIGS_DMP_SECRET=
...
[[ $OLD_VALUES_GK_CONFIG_ENCRYPTION_KEY -eq 'null' ]] && OLD_VALUES_GK_CONFIG_ENCRYPTION_KEY=
...
[[ $OLD_VALUES_MD_PARAMS_CREDS_ENCRYPTION_KEY -eq 'null' ]] && OLD_VALUES_MD_PARAMS_CREDS_ENCRYPTION_KEY=
...
[[ $OLD_VALUES_MD_PARAMS_CREDS_IV -eq 'null' ]] && OLD_VALUES_MD_PARAMS_CREDS_IV=
